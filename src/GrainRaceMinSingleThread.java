...
public class GrainRaceMinSingleThread {
    public static void main(String[] args) {
        ...
        engine.racedetectionengine.grainRaceMinSingleThread.GrainRaceEngine engine5 = new engine.racedetectionengine.grainRaceMinSingleThread.GrainRaceEngine(options.parserType, options.path);
        engine5.analyzeTrace(true, 0);
