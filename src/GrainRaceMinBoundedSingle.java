...
public class GrainRaceMinBoundedSingle {
    public static void main(String[] args) {
        ...
        engine.racedetectionengine.grainRaceMinBoundedSingle.GrainRaceEngine engine5 = new engine.racedetectionengine.grainRaceMinBoundedSingle.GrainRaceEngine(options.parserType, options.path);
        engine5.analyzeTrace(true, 0);
