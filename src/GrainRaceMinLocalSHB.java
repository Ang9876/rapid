...
public class GrainRaceMinLocalSHB {
    public static void main(String[] args) {
        ...
        engine.racedetectionengine.grainRaceMinLocalSHB.GrainRaceEngine engine3 = new engine.racedetectionengine.grainRaceMinLocalSHB.GrainRaceEngine(options.parserType, options.path, true, true, 5);
