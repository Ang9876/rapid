...
public class GrainRaceMinWeak {
    public static void main(String[] args) {
        ...
        engine.racedetectionengine.grainRaceMinWeak.GrainRaceEngine engine3 = new engine.racedetectionengine.grainRaceMinWeak.GrainRaceEngine(options.parserType, options.path);
